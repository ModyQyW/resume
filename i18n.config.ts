export default defineI18nConfig(() => ({
  ...
  messages: {
    "zh-CN": {
      ...
      baseInfo: "{count} 年经验，懂得换位思考、用心打造产品的前端工程师。",
      ...
      techLeadAndMentoringTooltip: "我通过展示最佳实践来帮助初级开发人员进阶。",
      ...
      healthyRelationshipsTooltip: "我非常重视充满信任、诚实和友善的工作空间。",
      teamSpirit: "团队精神",
